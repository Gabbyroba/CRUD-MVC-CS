...
namespace CRUD_MVC_DEPLOY.Controllers
{
    public class ProdutoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Quantidade,Preço")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Quantidade,Preço")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
